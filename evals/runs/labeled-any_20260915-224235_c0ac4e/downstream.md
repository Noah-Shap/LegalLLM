...
Spans from `evals/runs/labeled-any_20260915-224235_c0ac4e` · 120 gold docs · resolver cache `data/processed/citation_cache.json` (15697 entries, **no network calls**) · BM25 fitted on the canonical build's train split minus the gold docs (550 of 587 rows; 37 gold docs excluded) · fixed targets = the gold span's resolved citations · 31 queries with ≥ 1 target.
...
|---|---:|---:|---:|---:|
| docs with a span | 100/120 | 82/120 | 79/120 | 87/120 |
| docs with ≥ 1 resolved citation (all gold docs) | 42.5% | 25.8% | 24.2% | 25.8% |
| docs with ≥ 1 resolved citation (docs that have a facts section) | 46.0% | 32.2% | 33.3% | 35.6% |
| unique case cites / resolved / cached-unresolved / uncached | 965 / 628 / 337 / 0 | 170 / 78 / 56 / 36 | 118 / 74 / 34 / 10 | 158 / 105 / 43 / 10 |
| resolved-target precision vs gold span | 15.1% | 88.5% | 95.9% | 100.0% |
| resolved-target recall vs gold span | 90.5% | 65.7% | 67.6% | 100.0% |
| spurious targets on no-facts docs (docs / targets) | 11/33 / 192 | 3/33 / 8 | 0/33 / 0 | 0/33 / 0 |

## BM25 retrieval (query = masked span text; targets fixed per doc)

| metric | rules_v2 | llm-v1 | llm-v2 | gold |
|---|---:|---:|---:|---:|
| Recall@10 (n = 31) | 0.126 | 0.145 | 0.120 | 0.143 |
| MRR@10 | 0.130 | 0.139 | 0.064 | 0.134 |
| Recall@10, queries where the method has a span | 0.135 (n=29) | 0.167 (n=27) | 0.133 (n=28) | 0.143 (n=31) |
| Recall@10 with the build's own (rules-derived) targets (n = 49) | 0.149 | 0.115 | 0.108 | 0.117 |

Paired Recall@10 vs `rules_v2`: `llm-v1` wins 2 / ties 28 / losses 1 · `llm-v2` wins 1 / ties 26 / losses 4 · `gold` wins 1 / ties 29 / losses 1
